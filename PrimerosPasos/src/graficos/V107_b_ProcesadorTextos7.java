// Referencias:
//
// Vídeo 107 - Procesador de textos - 5
//
...
public class V107_b_ProcesadorTextos7 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		V107_b_MenuProcesador_II mimarco = new V107_b_MenuProcesador_II();
...
class V107_b_MenuProcesador_II extends JFrame {

	public V107_b_MenuProcesador_II() {

		setBounds(500, 300, 550, 400);
		setTitle("Prueba procesador de textos - 4");

		V107_b_LaminaProcesador_II milamina = new V107_b_LaminaProcesador_II();
		add(milamina);
...
class V107_b_LaminaProcesador_II extends JPanel {

	public V107_b_LaminaProcesador_II() {
		...
		configura_menu("Negrita", "estilo", "", Font.BOLD, 0, "src/recursos/famfamfam_silk_icons_v013/icons/text_bold.png");
		configura_menu("Cursiva", "estilo", "", Font.ITALIC, 0, "src/recursos/famfamfam_silk_icons_v013/icons/text_italic.png");
