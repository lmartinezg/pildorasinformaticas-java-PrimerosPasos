// Referencias:
//
// Vídeo 109 - Menús emergentes(PopUp Menu)
//
// Clase JPopupMenu
// Método setComponentPopUpMenu(Component c)
//
...
public class V109_c_MenusEmergentes {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		V109_c_Marco mimarco = new V109_c_Marco();
...
class V109_c_Marco extends JFrame {
	...
	public V109_c_Marco() {
		...
		V109_c_Lamina milamina = new V109_c_Lamina();
		add(milamina);
...
class V109_c_Lamina extends JPanel {

	public V109_c_Lamina() {
