...
public class V121_Tipos_Cuadros_Dialogos {
	...
	private class Accion_botones implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == boton1) {
				...
				JOptionPane.showMessageDialog(Lamina_Cuadros_Dialogos.this, "Mensaje de prueba", "Advertencia",
						JOptionPane.ERROR_MESSAGE);
				// JOptionPane.showMessageDialog(Lamina_Cuadros_Dialogos.this,
				// "Mensaje de prueba", "Advertencia",
				// JOptionPane.INFORMATION_MESSAGE);
				// JOptionPane.showMessageDialog(Lamina_Cuadros_Dialogos.this,
				// "Mensaje de prueba", "Advertencia",
				// JOptionPane.WARNING_MESSAGE);
