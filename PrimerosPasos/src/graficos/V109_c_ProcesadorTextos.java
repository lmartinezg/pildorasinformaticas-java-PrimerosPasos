// Referencias:
//
// Vídeo 109 - Menús emergentes
//
// Añadir menú emergente al procesador de textos
...
public class V109_c_ProcesadorTextos {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		V109_c_MenuProcesador_II mimarco = new V109_c_MenuProcesador_II();
...
class V109_c_MenuProcesador_II extends JFrame {

	public V109_c_MenuProcesador_II() {

		setBounds(500, 300, 550, 400);
		setTitle("Prueba procesador de textos con menú emergente");

		V109_c_LaminaProcesador_II milamina = new V109_c_LaminaProcesador_II();
		add(milamina);
...
class V109_c_LaminaProcesador_II extends JPanel {

	public V109_c_LaminaProcesador_II() {
