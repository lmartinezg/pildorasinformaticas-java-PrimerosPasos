// Referencias:
//
// Vídeo 112 - Barras de herramientas II
//
...
public class V112_BarrasHerramientas_b {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		V112_MenuProcesador_II mimarco = new V112_MenuProcesador_II();
...
class V112_MenuProcesador_II extends JFrame {

	public V112_MenuProcesador_II() {

		setBounds(500, 300, 550, 400);
		setTitle("Prueba procesador de textos con menú emergente");

		V112_c_LaminaProcesador_II milamina = new V112_c_LaminaProcesador_II();
		add(milamina);
...
class V112_c_LaminaProcesador_II extends JPanel {

	public V112_c_LaminaProcesador_II() {
